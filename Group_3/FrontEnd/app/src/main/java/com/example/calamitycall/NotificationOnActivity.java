        ...
        notificationSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    Toast.makeText(NotificationOnActivity.this, "Notifications Enabled", Toast.LENGTH_SHORT).show();
                } else {
                    // Notifications disabled
                    Toast.makeText(NotificationOnActivity.this, "Notifications Disabled", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
