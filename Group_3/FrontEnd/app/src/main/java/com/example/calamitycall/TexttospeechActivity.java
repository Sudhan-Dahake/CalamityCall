...
public class TexttospeechActivity extends AppCompatActivity {
    ...
    private void loadPreferences() {
        ...
        watchSwitch.setChecked(sharedPreferences.getBoolean("watch_tts", true));
        warningSwitch.setChecked(sharedPreferences.getBoolean("warning_tts", true));
        urgentSwitch.setChecked(sharedPreferences.getBoolean("urgent_tts", true));
        criticalSwitch.setChecked(sharedPreferences.getBoolean("critical_tts", true));
    ...
    private void savePreferences() {
        ...
        new Thread(() -> {
            ...
            editor.putBoolean("watch_tts", watchSwitch.isChecked());
            editor.putBoolean("warning_tts", warningSwitch.isChecked());
            editor.putBoolean("urgent_tts", urgentSwitch.isChecked());
            editor.putBoolean("critical_tts", criticalSwitch.isChecked());
            editor.apply();
