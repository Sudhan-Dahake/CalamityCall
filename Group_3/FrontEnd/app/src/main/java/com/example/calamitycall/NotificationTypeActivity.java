        ...
        notificationSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    Toast.makeText(NotificationTypeActivity.this, "Notifications Enabled", Toast.LENGTH_SHORT).show();
                } else {
                    // Notifications disabled
                    Toast.makeText(NotificationTypeActivity.this, "Notifications Disabled", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
